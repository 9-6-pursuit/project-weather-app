...
function displayCard(json){
    ...
    // weather gifs
            ...
            if ((descOfWeather === "Overcast")||(descOfWeather === "Partly cloudy")||(descOfWeather === "rain-cloud")) {
                let weatherImg = document.createElement("img")
                weatherImg.setAttribute("src", "./assets/icons8-rain-cloud.gif")
                divWeatherBox.prepend(weatherImg)
            } else if (descOfWeather === "fog"){
                let weatherImg = document.createElement("img")
                weatherImg.setAttribute("src", "./assets/icons8-fog.gif")
                divWeatherBox.prepend(weatherImg)
            } else if (descOfWeather === "icy"){
                let weatherImg = document.createElement("img")
                weatherImg.setAttribute("src", "./assets/icons8-icy-50.gif")
                divWeatherBox.prepend(weatherImg)
            } else if (descOfWeather === "light snow"){
                let weatherImg = document.createElement("img")
                weatherImg.setAttribute("src", "./assets/icons8-light-snow.gif")
                divWeatherBox.prepend(weatherImg)
            } else if (descOfWeather === "night"){
                let weatherImg = document.createElement("img")
                weatherImg.setAttribute("src", "./assets/icons8-night.gif")
                divWeatherBox.prepend(weatherImg)
            } else if (descOfWeather === "storm"){
                let weatherImg = document.createElement("img")
                weatherImg.setAttribute("src", "./assets/icons8-storm.gif")
                divWeatherBox.prepend(weatherImg)
            } else if (descOfWeather === "summer"){
                let weatherImg = document.createElement("img")
                weatherImg.setAttribute("src", "./assets/icons8-summer.gif")
                divWeatherBox.prepend(weatherImg)
            } else if (descOfWeather === "torrential-rain"){
                let weatherImg = document.createElement("img")
                weatherImg.setAttribute("src", "./assets/icons8-torrential-rain.gif")
                divWeatherBox.prepend(weatherImg)
            } else if (descOfWeather === "wind"){
                let weatherImg = document.createElement("img")
                weatherImg.setAttribute("src", "./assets/icons8-wind.gif")
                divWeatherBox.prepend(weatherImg)
            }
        ...
        // let PrevSearchArray = []
        //     if (!PrevSearchArray.includes(areaName)) {
        //         PrevSearchH1.push(areaName)
        //         let PrevSearchH1 = document.getElementsByClassName("previous-searches-h1")
        //         let PrevSearchli = document.createElement("li")
        //         PrevSearchli.textContent = areaName
        //         PrevSearchH1.append(PrevSearchli)
        //     }else {
        //         console.log(`${areaName} has already been added to previous searches`)
        //     }
        ...
        function fToCConverter(num) {
            num = parseInt(num)
            document.getElementById("CelsiusOutput").innerHTML=(num-32)/1.8;
        }

        function cToFConverter(num) {
            num = parseInt(num)
            document.getElementById("FarenheitOuput").innerHTML=((num * (9/5))+32);
        }
